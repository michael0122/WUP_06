...
It appears that the black has the thus majority in opposing CAPPUN compared to other and the whites who are more in favor for the CAPPUN.
...
According to what the table presents there are only 11.70 black in favor of CAPPUN compared to 23.27 opposers, while the whites are 83.33 in favor of CAPPUN and that shows that there is a perceived difference between black and white. 
...
so when we take a look at the fisherXY we saw that there is a perceived difference between black and other and white as there were no significant differences between the white and others.
